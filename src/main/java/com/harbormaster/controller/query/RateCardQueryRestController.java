...
/**
 * <h2>RateCardQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity RateCard.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class RateCardQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public RateCard load( @RequestParam(required=true) UUID rateCardId ) {
    ...
    public List<RateCard> loadAll() {                
    	...
    	try {
            ...
            LOGGER.log( Level.WARNING,  "failed to load all RateCards ", exc );
        	return null;
        }
