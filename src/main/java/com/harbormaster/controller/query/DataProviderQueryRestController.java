...
/**
 * <h2>DataProviderQueryRestController as REST API</h2>
 * <p>
 * Implements Spring Controller query CQRS processing for entity DataProvider.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
public class DataProviderQueryRestController extends BaseSpringRestController {
     ...
     */    
    @GetMapping("/load")
    public DataProvider load( @RequestParam(required=true) UUID dataProviderId ) {
    ...
    public List<DataProvider> loadAll() {                
    	...
    	try {
            ...
            LOGGER.log( Level.WARNING,  "failed to load all DataProviders ", exc );
        	return null;
        }
