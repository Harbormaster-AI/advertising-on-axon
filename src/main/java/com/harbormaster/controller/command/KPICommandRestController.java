...
/**
 * <h2>KPICommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity KPI.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/KPICommand")
public class KPICommandRestController extends BaseSpringRestController {

	public KPICommandRestController( KPIService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a KPI.
     * @param		KPI	kPI
     ...
     */
	@PutMapping("/update")
    public CompletableFuture<Void> update( @RequestBody(required=true) UpdateKPICommand command ) {
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID kPIId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(KPICommandRestController.class.getName());
