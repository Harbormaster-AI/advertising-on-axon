...
/**
 * <h2>LineItemCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity LineItem.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/LineItemCommand")
public class LineItemCommandRestController extends BaseSpringRestController {

	public LineItemCommandRestController( LineItemService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a LineItem.
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID lineItemId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(LineItemCommandRestController.class.getName());
