...
/**
 * <h2>AdAccountCommandRestController as REST API</h2>
 * <p>
 * Implements Spring Controller command CQRS processing for entity AdAccount.
 * </p>
  * Generated By Harbormaster
 *
 * Generated From
...
@CrossOrigin
@RestController
@RequestMapping("/AdAccountCommand")
public class AdAccountCommandRestController extends BaseSpringRestController {

	public AdAccountCommandRestController( AdAccountService service ) {
		this.service = service;
	}
	
    /**
     * Handles create a AdAccount.
    ...
    public CompletableFuture<Void> delete( @RequestParam(required=true) UUID adAccountId  ) {
    	CompletableFuture<Void> completableFuture = null;
...
//************************************************************************
    ...
    private static final Logger LOGGER = Logger.getLogger(AdAccountCommandRestController.class.getName());
